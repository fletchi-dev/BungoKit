...
//
// File: SearchResultOfContentItemPublicContract.swift

import Foundation

public struct SearchResultOfContentItemPublicContract: Codable {
    public var hasMore: Bool?
    public var query: Queries.PagedQuery?
    public var replacementContinuationToken: String?
    public var results: [Content.ContentItemPublicContract]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([Content.ContentItemPublicContract].self, forKey: CodingKeys.results)
