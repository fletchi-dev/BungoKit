...
//
// File: SearchResultOfFireteamResponse.swift

import Foundation

public struct SearchResultOfFireteamResponse: Codable {
    public var hasMore: Bool?
    public var query: Queries.PagedQuery?
    public var replacementContinuationToken: String?
    public var results: [Fireteam.FireteamResponse]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([Fireteam.FireteamResponse].self, forKey: CodingKeys.results)
