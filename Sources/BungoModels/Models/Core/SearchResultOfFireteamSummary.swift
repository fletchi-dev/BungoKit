...
//
// File: SearchResultOfFireteamSummary.swift

import Foundation

public struct SearchResultOfFireteamSummary: Codable {
    ...
    public var results: [Fireteam.FireteamSummary]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([Fireteam.FireteamSummary].self, forKey: CodingKeys.results)
