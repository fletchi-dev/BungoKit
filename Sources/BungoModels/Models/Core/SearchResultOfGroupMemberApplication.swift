...
//
// File: SearchResultOfGroupMemberApplication.swift

import Foundation

public struct SearchResultOfGroupMemberApplication: Codable {
    public var hasMore: Bool?
    public var query: Queries.PagedQuery?
    public var replacementContinuationToken: String?
    public var results: [GroupsV2.GroupMemberApplication]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([GroupsV2.GroupMemberApplication].self, forKey: CodingKeys.results)
