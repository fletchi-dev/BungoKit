...
//
// File: SearchResultOfTrendingEntry.swift

import Foundation

public struct SearchResultOfTrendingEntry: Codable {
    public var hasMore: Bool?
    public var query: Queries.PagedQuery?
    public var replacementContinuationToken: String?
    public var results: [Trending.TrendingEntry]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([Trending.TrendingEntry].self, forKey: CodingKeys.results)
