...
//
// File: SearchResultOfGroupPotentialMembership.swift

import Foundation

public struct SearchResultOfGroupPotentialMembership: Codable {
    public var hasMore: Bool?
    public var query: Queries.PagedQuery?
    public var replacementContinuationToken: String?
    public var results: [GroupsV2.GroupPotentialMembership]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([GroupsV2.GroupPotentialMembership].self, forKey: CodingKeys.results)
