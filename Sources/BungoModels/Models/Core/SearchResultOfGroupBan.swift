...
//
// File: SearchResultOfGroupBan.swift

import Foundation

public struct SearchResultOfGroupBan: Codable {
    public var hasMore: Bool?
    public var query: Queries.PagedQuery?
    public var replacementContinuationToken: String?
    public var results: [GroupsV2.GroupBan]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([GroupsV2.GroupBan].self, forKey: CodingKeys.results)
