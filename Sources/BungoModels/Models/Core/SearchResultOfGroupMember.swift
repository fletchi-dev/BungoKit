...
//
// File: SearchResultOfGroupMember.swift

import Foundation

public struct SearchResultOfGroupMember: Codable {
    public var hasMore: Bool?
    public var query: Queries.PagedQuery?
    public var replacementContinuationToken: String?
    public var results: [GroupsV2.GroupMember]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([GroupsV2.GroupMember].self, forKey: CodingKeys.results)
