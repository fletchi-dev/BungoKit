...
//
// File: SearchResultOfDestinyEntitySearchResultItem.swift

import Foundation

public struct SearchResultOfDestinyEntitySearchResultItem: Codable {
    public var hasMore: Bool?
    public var query: Queries.PagedQuery?
    public var replacementContinuationToken: String?
    public var results: [Destiny.Definitions.DestinyEntitySearchResultItem]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        results = try? container.decode([Destiny.Definitions.DestinyEntitySearchResultItem].self, forKey: CodingKeys.results)
