...
//
// File: DestinyTalentGridDefinition.swift
...
public extension Destiny.Definitions {
    ...
    struct DestinyTalentGridDefinition: Codable {
        ...
        public var exclusiveSets: [Destiny.Definitions.DestinyTalentNodeExclusiveSetDefinition]?
        ...
        public var gridLevelPerColumn: Int32?
        ...
        public var nodeCategories: [Destiny.Definitions.DestinyTalentNodeCategory]?
        ...
        public var nodes: [Destiny.Definitions.DestinyTalentNodeDefinition]?
        ...
        public init(from decoder: Decoder) throws {
            ...
            maxGridLevel = try? container.decode(Int32.self, forKey: CodingKeys.maxGridLevel)
            nodeCategories = try? container.decode([Destiny.Definitions.DestinyTalentNodeCategory].self, forKey: CodingKeys.nodeCategories)
            nodes = try? container.decode([Destiny.Definitions.DestinyTalentNodeDefinition].self, forKey: CodingKeys.nodes)
