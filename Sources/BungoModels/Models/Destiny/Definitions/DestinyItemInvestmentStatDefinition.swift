...
//
// File: DestinyItemInvestmentStatDefinition.swift
...
public extension Destiny.Definitions {
    ...
    struct DestinyItemInvestmentStatDefinition: Codable {
        ...
        public var statTypeHash: UInt32?
        ...
        public init(from decoder: Decoder) throws {
            ...
            isConditionallyActive = try? container.decode(Bool.self, forKey: CodingKeys.isConditionallyActive)
            statTypeHash = try? container.decode(UInt32.self, forKey: CodingKeys.statTypeHash)
