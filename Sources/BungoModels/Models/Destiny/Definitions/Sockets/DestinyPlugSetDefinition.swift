...
//
// File: DestinyPlugSetDefinition.swift
...
public extension Destiny.Definitions.Sockets {
    ...
    struct DestinyPlugSetDefinition: Codable {
        ...
        public var reusablePlugItems: [Destiny.Definitions.DestinyItemSocketEntryPlugItemRandomizedDefinition]?
        ...
        public init(from decoder: Decoder) throws {
            ...
            isFakePlugSet = try? container.decode(Bool.self, forKey: CodingKeys.isFakePlugSet)
            redacted = try? container.decode(Bool.self, forKey: CodingKeys.redacted)
            reusablePlugItems = try? container.decode([Destiny.Definitions.DestinyItemSocketEntryPlugItemRandomizedDefinition].self, forKey: CodingKeys.reusablePlugItems)
        }
    }
}
