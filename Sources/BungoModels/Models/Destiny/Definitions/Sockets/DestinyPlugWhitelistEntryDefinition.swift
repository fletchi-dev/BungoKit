...
//
// File: DestinyPlugWhitelistEntryDefinition.swift
...
public extension Destiny.Definitions.Sockets {
    ...
    struct DestinyPlugWhitelistEntryDefinition: Codable {
        ...
        public var reinitializationPossiblePlugHashes: [UInt32]?

        public enum CodingKeys: String, CodingKey {
            case categoryHash
            case categoryIdentifier
            case reinitializationPossiblePlugHashes
        }
        ...
        public init(from decoder: Decoder) throws {
            ...
            reinitializationPossiblePlugHashes = try? container.decode([UInt32].self, forKey: CodingKeys.reinitializationPossiblePlugHashes)
        }
    }
}
