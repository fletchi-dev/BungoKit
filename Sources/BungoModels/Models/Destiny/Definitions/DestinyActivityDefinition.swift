...
//
// File: DestinyActivityDefinition.swift
...
public extension Destiny.Definitions {
    ...
    struct DestinyActivityDefinition: Codable {
        ...
        public var activityGraphList: [Destiny.Definitions.DestinyActivityGraphListEntryDefinition]?
        /// The recommended light level for this activity.
        public var activityLightLevel: Int32?
        ...
        public var activityLocationMappings: [Destiny.Constants.DestinyEnvironmentLocationMapping]?
        ...
        public var activityTypeHash: UInt32?
        ...
        public var challenges: [Destiny.Definitions.DestinyActivityChallengeDefinition]?
        ...
        public var guidedGame: Destiny.Definitions.DestinyActivityGuidedBlockDefinition?
        ...
        public var insertionPoints: [Destiny.Definitions.DestinyActivityInsertionPointDefinition]?
        ...
        public var loadouts: [Destiny.Definitions.DestinyActivityLoadoutRequirementSet]?
        /// This block of data provides information about the Activity's matchmaking attributes: how many people can join and such.
        public var matchmaking: Destiny.Definitions.DestinyActivityMatchmakingBlockDefinition?
        ...
        public var modifiers: [Destiny.Definitions.DestinyActivityModifierReferenceDefinition]?
        ...
        public var optionalUnlockStrings: [Destiny.Definitions.DestinyActivityUnlockStringDefinition]?
        ...
        public var originalDisplayProperties: Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition?
        ...
        public var playlistItems: [Destiny.Definitions.DestinyActivityPlaylistItemDefinition]?
        ...
        public var rewards: [Destiny.Definitions.DestinyActivityRewardDefinition]?
        ...
        public var selectionScreenDisplayProperties: Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition?
        /// The difficulty tier of the activity.
        public var tier: Int32?

        public enum CodingKeys: String, CodingKey {
            case activityGraphList
            case activityLightLevel
            case activityLocationMappings
            case activityModeHashes
            case activityModeTypes
            case activityTypeHash
            case challenges
            ...
            case matchmaking
            case modifiers
            case optionalUnlockStrings
            case originalDisplayProperties
            case pgcrImage
            case placeHash
            case playlistItems
            case redacted
            ...
            case releaseTime
            case rewards
            case selectionScreenDisplayProperties
            case tier
        }
        ...
        public init(from decoder: Decoder) throws {
            ...
            activityGraphList = try? container.decode([Destiny.Definitions.DestinyActivityGraphListEntryDefinition].self, forKey: CodingKeys.activityGraphList)
            activityLightLevel = try? container.decode(Int32.self, forKey: CodingKeys.activityLightLevel)
            activityLocationMappings = try? container.decode([Destiny.Constants.DestinyEnvironmentLocationMapping].self, forKey: CodingKeys.activityLocationMappings)
            ...
            activityTypeHash = try? container.decode(UInt32.self, forKey: CodingKeys.activityTypeHash)
            challenges = try? container.decode([Destiny.Definitions.DestinyActivityChallengeDefinition].self, forKey: CodingKeys.challenges)
            ...
            guidedGame = try? container.decode(Destiny.Definitions.DestinyActivityGuidedBlockDefinition.self, forKey: CodingKeys.guidedGame)
            ...
            insertionPoints = try? container.decode([Destiny.Definitions.DestinyActivityInsertionPointDefinition].self, forKey: CodingKeys.insertionPoints)
            isPlaylist = try? container.decode(Bool.self, forKey: CodingKeys.isPlaylist)
            isPvP = try? container.decode(Bool.self, forKey: CodingKeys.isPvP)
            loadouts = try? container.decode([Destiny.Definitions.DestinyActivityLoadoutRequirementSet].self, forKey: CodingKeys.loadouts)
            matchmaking = try? container.decode(Destiny.Definitions.DestinyActivityMatchmakingBlockDefinition.self, forKey: CodingKeys.matchmaking)
            modifiers = try? container.decode([Destiny.Definitions.DestinyActivityModifierReferenceDefinition].self, forKey: CodingKeys.modifiers)
            optionalUnlockStrings = try? container.decode([Destiny.Definitions.DestinyActivityUnlockStringDefinition].self, forKey: CodingKeys.optionalUnlockStrings)
            originalDisplayProperties = try? container.decode(Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition.self, forKey: CodingKeys.originalDisplayProperties)
            ...
            playlistItems = try? container.decode([Destiny.Definitions.DestinyActivityPlaylistItemDefinition].self, forKey: CodingKeys.playlistItems)
            redacted = try? container.decode(Bool.self, forKey: CodingKeys.redacted)
            releaseIcon = try? container.decode(String.self, forKey: CodingKeys.releaseIcon)
            releaseTime = try? container.decode(Int32.self, forKey: CodingKeys.releaseTime)
            rewards = try? container.decode([Destiny.Definitions.DestinyActivityRewardDefinition].self, forKey: CodingKeys.rewards)
            selectionScreenDisplayProperties = try? container.decode(Destiny.Definitions.Common.DestinyDisplayPropertiesDefinition.self, forKey: CodingKeys.selectionScreenDisplayProperties)
            tier = try? container.decode(Int32.self, forKey: CodingKeys.tier)
        }
    }
}
