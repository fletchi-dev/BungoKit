...
//
// File: DestinyStatDefinition.swift
...
public extension Destiny.Definitions {
    ...
    struct DestinyStatDefinition: Codable {
        ...
        public var aggregationType: Destiny.DestinyStatAggregationType?
        ...
        public var statCategory: Destiny.DestinyStatCategory?
        ...
        public init(from decoder: Decoder) throws {
            ...
            aggregationType = try? container.decode(Destiny.DestinyStatAggregationType.self, forKey: CodingKeys.aggregationType)
            ...
            hasComputedBlock = try? container.decode(Bool.self, forKey: CodingKeys.hasComputedBlock)
            ...
            statCategory = try? container.decode(Destiny.DestinyStatCategory.self, forKey: CodingKeys.statCategory)
        }
    }
}
