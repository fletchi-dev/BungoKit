...
//
// File: DestinyMilestoneQuestRewardsDefinition.swift
...
public extension Destiny.Definitions.Milestones {
    ...
    struct DestinyMilestoneQuestRewardsDefinition: Codable {
        ...
        public var items: [Destiny.Definitions.Milestones.DestinyMilestoneQuestRewardItem]?
        ...
        public init(from decoder: Decoder) throws {
            ...
            items = try? container.decode([Destiny.Definitions.Milestones.DestinyMilestoneQuestRewardItem].self, forKey: CodingKeys.items)
        }
    }
}
