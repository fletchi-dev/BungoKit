...
//
// File: DestinyProgressionLevelRequirementDefinition.swift

import Foundation

public extension Destiny.Definitions.Progression {
    ...
    struct DestinyProgressionLevelRequirementDefinition: Codable {
        ...
        public var requirementCurve: [Interpolation.InterpolationPointFloat]?
        ...
        public init(from decoder: Decoder) throws {
            ...
            requirementCurve = try? container.decode([Interpolation.InterpolationPointFloat].self, forKey: CodingKeys.requirementCurve)
        }
    }
}
