...
//
// File: DestinyLoadoutColorDefinition.swift

import Foundation

public extension Destiny.Definitions.Loadouts {
    struct DestinyLoadoutColorDefinition: Codable {
        public var colorImagePath: String?
        ...
        public init(from decoder: Decoder) throws {
            ...
            colorImagePath = try? container.decode(String.self, forKey: CodingKeys.colorImagePath)
