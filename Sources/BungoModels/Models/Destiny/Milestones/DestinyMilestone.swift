...
public extension Destiny.Milestones {
    ...
    struct DestinyMilestone: Codable {
        ...
        public var activities: [Destiny.Milestones.DestinyMilestoneChallengeActivity]?
        ...
        public var availableQuests: [Destiny.Milestones.DestinyMilestoneQuest]?
        ...
        public var rewards: [Destiny.Milestones.DestinyMilestoneRewardCategory]?
        ...
        public var vendors: [Destiny.Milestones.DestinyMilestoneVendor]?
        ...
        public init(from decoder: Decoder) throws {
            ...
            activities = try? container.decode([Destiny.Milestones.DestinyMilestoneChallengeActivity].self, forKey: CodingKeys.activities)
            availableQuests = try? container.decode([Destiny.Milestones.DestinyMilestoneQuest].self, forKey: CodingKeys.availableQuests)
            ...
            rewards = try? container.decode([Destiny.Milestones.DestinyMilestoneRewardCategory].self, forKey: CodingKeys.rewards)
            startDate = try? container.decode(Date.self, forKey: CodingKeys.startDate)
            values = try? container.decode([String: Float].self, forKey: CodingKeys.values)
            vendorHashes = try? container.decode([UInt32].self, forKey: CodingKeys.vendorHashes)
            vendors = try? container.decode([Destiny.Milestones.DestinyMilestoneVendor].self, forKey: CodingKeys.vendors)
        }
    }
}
