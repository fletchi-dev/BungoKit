...
//
// File: DestinyVendorSaleItemComponent.swift
...
public extension Destiny.Entities.Vendors {
    ...
    struct DestinyVendorSaleItemComponent: Codable {
        ...
        public var augments: Destiny.DestinyVendorItemState?
        ...
        public var requiredUnlocks: [UInt32]?
        ...
        public var saleStatus: Destiny.VendorItemStatus?
        ...
        /// Prefer using failureIndexes instead. These are provided for informational purposes, but have largely been supplanted by failureIndexes.
        public var unlockStatuses: [Destiny.DestinyUnlockStatus]?
        ...
        public init(from decoder: Decoder) throws {
            ...
            augments = try? container.decode(Destiny.DestinyVendorItemState.self, forKey: CodingKeys.augments)
            ...
            requiredUnlocks = try? container.decode([UInt32].self, forKey: CodingKeys.requiredUnlocks)
            saleStatus = try? container.decode(Destiny.VendorItemStatus.self, forKey: CodingKeys.saleStatus)
            unlockStatuses = try? container.decode([Destiny.DestinyUnlockStatus].self, forKey: CodingKeys.unlockStatuses)
