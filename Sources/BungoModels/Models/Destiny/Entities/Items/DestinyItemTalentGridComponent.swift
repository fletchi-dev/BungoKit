...
//
// File: DestinyItemTalentGridComponent.swift
...
public extension Destiny.Entities.Items {
    ...
    struct DestinyItemTalentGridComponent: Codable {
        ...
        public var gridProgression: Destiny.DestinyProgression?
        ...
        public var nodes: [Destiny.DestinyTalentNode]?
        ...
        public init(from decoder: Decoder) throws {
            ...
            gridProgression = try? container.decode(Destiny.DestinyProgression.self, forKey: CodingKeys.gridProgression)
            isGridComplete = try? container.decode(Bool.self, forKey: CodingKeys.isGridComplete)
            nodes = try? container.decode([Destiny.DestinyTalentNode].self, forKey: CodingKeys.nodes)
